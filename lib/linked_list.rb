...
#https://stackoverflow.com/questions/15659557/linked-list-implementation-for-a-stack
...
class LinkedList
  ...
  def pop
    ...
    return popped_data = data_array.pop
  ...
  #need a way to update the list from the array generated by above code.
  #maybe .each method to iterate over list after @head is defined?
end
